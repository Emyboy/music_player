...
export const bg_img = 'https://e-cdns-images.dzcdn.net/images/artist/3590cb6cac25b0b1ea6918eec878145e/250x250-000000-80-0-0.jpg'
...
export default function page() {
  return (
    <div className=''>
      <div className="flex min-w-[1000px] min-h-[500px] absolute">
        <PlayerLeft />
        <PlayerRight />
      </div>
      <div className='min-w-[1000px] min-h-[500px] bg-white opacity-20- border border-white rounded-xl flex z-50 p-5 opacity-20'>
      </div>
    </div>
  )
}
